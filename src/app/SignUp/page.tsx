  ...
  return (
    <div className="container flex justify-center">
      <div className="shadow-lg p-5 w-full md:w-[800px] flex justify-center flex-col items-center">
        ...
        <p>
          Already have an account? <Link href={"/SignIn"} className="underline">
            Log in
          </Link>
        </p>
        <button className="bg-black text-white w-full p-2 flex justify-center items-center gap-2 rounded-full my-3" onClick={handleGoogleSignUp}>
